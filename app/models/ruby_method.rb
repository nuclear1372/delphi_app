class RubyMethod < ActiveHash::Base
  self.data = [
    ...
    {id: 45, first_priolity: '数', second_priolity: '切り捨て', therd_priolity: '切り上げ', forth_priolity: '丸', fifth_priolity: '切りのいい', suggestion: 'roundメソッドを提案。<br>対象の数値ともっとも近い整数を返します。<br>第一引数:小数点以下の有効桁数を整数で指定。負の整数を指定した場合、小数点位置から左に少なくともn個の0が並びます。<br>第二引数:ちょうど半分の値の丸め方を指定', example: '25.round(-1, half: :up) # => 30<br>25.round(-1, half: :down) # => 20<br>25.round(-1, half: :even) # => 20'},
